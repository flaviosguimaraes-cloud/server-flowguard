                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right hidden sm:block">
                        <div className="text-xs font-bold text-text-primary">{formatBytes(item.bytes)}</div>
                        <div className="text-[10px] text-text-secondary">{item.flows.toLocaleString()} flows</div>
                      </div>
                      ...
                      <div className="space-y-1">
                        {cdnDetails.top_ips.map((ip: any, i: number) => (
                          <div key={i} className="grid grid-cols-4 items-center gap-4 p-3 bg-bg-secondary rounded-lg border border-border/50 text-xs hover:border-primary/20 transition-colors">
                            ...
                            <div className="text-text-secondary font-medium">{formatBytes(ip.bytes)}</div>
                            <div className="text-text-secondary opacity-70">{ip.flows.toLocaleString()} flows</div>
