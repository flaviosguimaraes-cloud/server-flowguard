...
import { Link as LinkIcon, Activity, Clock, Network, RefreshCw, Cpu, FileCode, Database, Wifi } from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-text-primary">Anúncios BGP</h1>
            <p className="text-sm text-text-secondary">Sessões e rotas de mitigação ativas no speaker</p>
          </div>
        </div>
        <button 
          onClick={refresh}
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 px-1">
          ...
          <h2 className="text-lg font-bold text-text-primary">Rotas de Mitigação</h2>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {loadingRoutes ? (
                  ...
                  <tr>
                    <td colSpan={5} className="px-4 py-10 text-center text-text-secondary italic font-medium">Nenhuma rota de mitigação anunciada</td>
                  </tr>
                ) : (
